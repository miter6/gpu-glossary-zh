...
> H100 流式多处理器（SM）的内部架构图。 加载/存储单元 (Load/Store Units) 与 [特殊功能单元](/gpu-glossary/device-hardware/special-function-unit) 一同以粉色标注。修改自 NVIDIA 的 [H100 白皮书](https://modal-cdn.com/gpu-glossary/gtc22-whitepaper-hopper.pdf)。
