...
[内存层次结构](/gpu-glossary/device-software/memory-hierarchy) 的最底层是寄存器，用于存储由单个 [线程](/gpu-glossary/device-software/thread) 操作的信息。
